...
const BottomNavBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-10 bg-white shadow-lg flex justify-between items-center h-20 px-6">
      <div className="flex justify-around w-full">
        <div
          className="flex-1 text-center text-gray-600 hover:text-blue-500 cursor-pointer"
        ...
        >
            <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11 6C13.7614 6 16 8.23858 16 11M16.6588 16.6549L21 21M19 11C19 15.4183 15.4183 19 11 19C6.58172 19 3 15.4183 3 11C3 6.58172 6.58172 3 11 3C15.4183 3 19 6.58172 19 11Z" stroke="#000000" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </div>
        ...
        <div className="relative">
          <div
            className="absolute w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center bottom-4 left-1/2 transform -translate-x-1/2 shadow-lg cursor-pointer hover:bg-blue-600"
