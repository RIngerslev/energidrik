...
const BottomNavBar = () => {
  ...
  return (
    <div className="fixed h-[85px] bottom-0 left-0 right-0 z-10 bg-[#111D4A] shadow-lg flex justify-between  px-6 border-t-2 border-gray-200">
      <div className="flex justify-around w-full">
        ...
        <div className="relative">
          <div
            className="absolute w-16 h-16 border-2 bg-white text-black text-xl font-bold rounded-full flex items-center justify-center bottom-[52px] left-1/2 transform -translate-x-1/2 shadow-lg cursor-pointer hover:bg-gray-300"
